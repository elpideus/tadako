...
var Episode = /** @class */ (function () {
    ...
    function Episode(url) {
         ...
         */
        this.getDownloadURL = function () { return __awaiter(_this, void 0, void 0, function () {
            var data, $;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        $ = cheerio.load(data);
                        return [2 /*return*/, $("#download .widget.downloads .widget-body #alternativeDownloadLink").attr("href")];
                }
            });
        }); };
        this.url = url;
